        ...
        <div class="col-md-8">
            <div class="card card-success card-outline">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-money-bill-wave mr-1"></i> Datos del pago</h3>
                </div>
                <form action="{{ route('pagos.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="reserva_id" id="reserva_id" class="form-control @error('reserva_id') is-invalid @enderror" required>
                                ...
                                @foreach($reservas as $reserva)
                                    <option value="{{ $reserva->id }}" {{ old('reserva_id', $selectedReservaId) == $reserva->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="date" name="fecha_pago" id="fecha_pago" class="form-control @error('fecha_pago') is-invalid @enderror" value="{{ old('fecha_pago', now()->toDateString()) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="observaciones" id="observaciones" rows="3" class="form-control @error('observaciones') is-invalid @enderror" placeholder="Ej. Pago inicial, saldo pendiente, etc.">{{ old('observaciones') }}</textarea>
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-success"><i class="fas fa-save mr-1"></i>Guardar pago</button>
                    </div>
                </form>
            </div>
        </div>
