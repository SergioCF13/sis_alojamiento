            ...
            <div class="card card-warning card-outline">
                ...
                <form action="{{ route('reservas.update', $reserva) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3 form-group">
                                ...
                                <input type="date" name="fecha_ingreso" id="fecha_ingreso" class="form-control @error('fecha_ingreso') is-invalid @enderror" value="{{ old('fecha_ingreso', $reserva->fecha_ingreso) }}" required>
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="time" name="hora_ingreso" id="hora_ingreso" class="form-control @error('hora_ingreso') is-invalid @enderror" value="{{ old('hora_ingreso', $reserva->hora_ingreso) }}" required>
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="date" name="fecha_salida" id="fecha_salida" class="form-control @error('fecha_salida') is-invalid @enderror" value="{{ old('fecha_salida', $reserva->fecha_salida) }}" required>
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="time" name="hora_salida" id="hora_salida" class="form-control @error('hora_salida') is-invalid @enderror" value="{{ old('hora_salida', $reserva->hora_salida) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="number" min="1" name="cantidad_persona" id="cantidad_persona" class="form-control @error('cantidad_persona') is-invalid @enderror" value="{{ old('cantidad_persona', $reserva->cantidad_persona) }}" required>
                                @error('cantidad_persona')<span class="invalid-feedback d-block">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="estado">Estado <span class="text-danger">*</span></label>
                                <select name="estado" id="estado" class="form-control @error('estado') is-invalid @enderror" required>
                                    <option value="Reserva" {{ old('estado', $reserva->estado) == 'Reserva' ? 'selected' : '' }}>Reserva</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="observaciones" id="observaciones" rows="3" class="form-control @error('observaciones') is-invalid @enderror">{{ old('observaciones', $reserva->observaciones) }}</textarea>
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-warning"><i class="fas fa-save mr-1"></i>Actualizar reserva</button>
                    </div>
                </form>
            </div>
        </div>
